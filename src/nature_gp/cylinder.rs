...
use crate::{
    gp::{NAx1, NAx2, NAx3, NPnt, NTrsf, NVec},
...
mod tests {
    ...
    fn test_setters() {
        ...
        cyl.set_location(NPnt::new(1.0, 2.0, 3.0));
        assert_eq!(cyl.location(), &NPnt::new(1.0, 2.0, 3.0));
    ...
    fn test_axes() {
        ...
        assert_eq!(cyl.axis().location(), &NPnt::new(1.0, 2.0, 3.0));
        assert_eq!(cyl.axis().direction(), &NDir::new(0.0, 0.0, 1.0).unwrap());
    ...
    fn test_mirror_pnt() {
        ...
        cyl.mirror_pnt(&point);
        assert_eq!(cyl.location(), &NPnt::new(-1.0, 0.0, 0.0));
        assert_eq!(cyl.radius(), 5.0);
    }
    ...
    fn test_scale() {
        ...
        let point = NPnt::new(0.0, 0.0, 0.0);
        cyl.scale(&point, 2.0);
        assert_eq!(cyl.location(), &NPnt::new(2.0, 0.0, 0.0));
        assert_eq!(cyl.radius(), 10.0);

        cyl.scale(&point, -2.0);
        assert_eq!(cyl.location(), &NPnt::new(-4.0, 0.0, 0.0));
    ...
    fn test_translate_vec() {
        ...
        assert_eq!(cyl.location(), &NPnt::new(2.0, 3.0, 4.0));
        assert_eq!(cyl.radius(), 5.0);
    }
